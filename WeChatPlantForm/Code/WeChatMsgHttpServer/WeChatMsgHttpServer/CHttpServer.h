...
namespace ClientCore {
	...
	public:
		...
		void Start(const IpPortCfg& cfg,const std::string strToken)
		{
			m_strToken = strToken;
	...
	private:
		void Get_Chat(std::shared_ptr<HttpServer::Response> response, std::shared_ptr<HttpServer::Request> request);
