...
void SHA1Util::update(const std::string &s)
{
...
void SHA1Util::update(std::istream &is)
{
    while (true)
    {
...
std::string SHA1Util::from_file(const std::string &filename)
{
